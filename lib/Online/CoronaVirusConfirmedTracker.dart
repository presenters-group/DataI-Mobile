...
List<int> confirmedData = new List();
List<List<Series>> dataLineAPI;
List<dynamic> datesAPI = new List();
String _value = "All Data", kind;

class CoronaVirusConfirmedTracker extends StatefulWidget {
  ...
  @override
  _CoronaVirusConfirmedTrackerState createState() =>
      _CoronaVirusConfirmedTrackerState();
}

class _CoronaVirusConfirmedTrackerState
    extends State<CoronaVirusConfirmedTracker>
  ...
  getDataAPI() async {
    ...
    for (int i = 0; i < confirmedData.length; i++) {
            ...
            child: TabBarView(
              ...
              children: <Widget>[
                ...
                isLoading
                    ...
                    data: confirmedData, datesAPI: datesAPI, keyType: 2)
              ],
            )),
      ),
    );
